        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-10">
                <div class="about-image-wrap">
                    <img class="img-full" src="images/8a7436d3-e281-4c2f-a53b-6a789ee82849.jpeg" alt="About Us" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row no-gutters">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="container">
                        <div class="counter-img">
                            <img src="{{ asset("assets/front/images/about-us/icon/1.png") }}" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset("assets/front/images/about-us/icon/2.png") }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter white-smoke-bg">
                    <div class="counter-img">
                        <img src="{{ asset("assets/front/images/about-us/icon/3.png") }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset("assets/front/images/about-us/icon/4.png") }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">3984</h3>
                        </div>
                        <div class="counter-text">
